...
initial1='../../Task1_resample/pelvis/'
initial2='../../Task1_mask_MR_corrected/pelvis/'
initial3='../../Task1_mr_T1_registered/pelvis/'
initial4='../../Task1_mask_MR/pelvis/'
dirOut='../../Task1_final_images/pelvis/'
